...
import deltix.timebase.connector.service.timebase.TimebaseRawMessageService;
...
import static deltix.timebase.connector.service.timescale.TimescaleSqlGenerator.*;
...
public class TimescaleDataService {
    ...
    public MigrationMetadata saveMigrationMetadata(MigrationMetadata metadata) {
        ...
        namedJdbcTemplate.update(INSERT_MIGRATION_METADATA_STATEMENT, new MapSqlParameterSource(namedParameters), keyHolder, new String[] { "id" });
    ...
    public Optional<MigrationMetadata> getMigrationMetadata(String streamName) {
        try {
            return Optional.of(jdbcTemplate.queryForObject(GET_MIGRATION_METADATA_STATEMENT, (rs, rowNum) ->
    ...
    public void updateMigrationMetadata(MigrationMetadata metadata) {
        ...
        namedParameters.put("isSuccess", metadata.getIsSuccess());
        namedParameters.put("version", metadata.getVersion());
        namedJdbcTemplate.update(UPDATE_MIGRATION_METADATA_STATEMENT, namedParameters);
    }
